...
Version  : 0.184
Release  : 77
URL      : https://sourceware.org/elfutils/ftp/0.184/elfutils-0.184.tar.bz2
Source0  : https://sourceware.org/elfutils/ftp/0.184/elfutils-0.184.tar.bz2
Source1  : https://sourceware.org/elfutils/ftp/0.184/elfutils-0.184.tar.bz2.sig
...
%prep
%setup -q -n elfutils-0.184
cd %{_builddir}/elfutils-0.184
pushd ..
cp -a elfutils-0.184 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1620674828
...
cp %{_builddir}/elfutils-0.184/COPYING %{buildroot}/usr/share/package-licenses/elfutils/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/elfutils-0.184/COPYING-GPLV2 %{buildroot}/usr/share/package-licenses/elfutils/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/elfutils-0.184/COPYING-LGPLV3 %{buildroot}/usr/share/package-licenses/elfutils/f45ee1c765646813b442ca58de72e20a64a7ddba
cp %{_builddir}/elfutils-0.184/doc/COPYING-GFDL %{buildroot}/usr/share/package-licenses/elfutils/4c0910524984176680adb6b68de639864bc1f8d0
pushd ../build32/
%make_install32
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libasm-0.184.so
/usr/lib64/libasm.so.1
/usr/lib64/libdw-0.184.so
/usr/lib64/libdw.so.1
/usr/lib64/libelf-0.184.so
/usr/lib64/libelf.so.1

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libasm-0.184.so
/usr/lib32/libasm.so.1
/usr/lib32/libdw-0.184.so
/usr/lib32/libdw.so.1
/usr/lib32/libelf-0.184.so
