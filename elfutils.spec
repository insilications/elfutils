...
export LANG=C
export SOURCE_DATE_EPOCH=1528649046
...
%configure --disable-static --program-prefix=eu- --with-zlib
make  %{?_smp_mflags}
...
%configure --disable-static --program-prefix=eu- --with-zlib   --libdir=/usr/lib32 --build=i686-generic-linux-gnu --host=i686-generic-linux-gnu --target=i686-clr-linux-gnu
make  %{?_smp_mflags}
popd
%check
export LANG=C
